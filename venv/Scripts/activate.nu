...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\1-Uni\Project-Bachelor\Melika-Baharnemati(Bachelor-Project)\Real-time vehicle detection and tracking\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\1-Uni\Project-Bachelor\Melika-Baharnemati(Bachelor-Project)\Real-time vehicle detection and tracking\venv\Scripts\deactivate.nu'
